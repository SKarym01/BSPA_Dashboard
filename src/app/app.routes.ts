...
import { BackendCheckComponent } from './components/backend-check/backend-check.component';
...
export const routes: Routes = [
    ...
    // Einziger Backend-Touchpoint: prüft GET {apiBaseUrl}/health.
    { path: 'backend-check', component: BackendCheckComponent },

    // Existing BSPA workflow routes.
